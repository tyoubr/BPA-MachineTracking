...
namespace BPAMatchineTrack.Controllers
{
    public class RentMCRequisitionController : Controller
    {
        ...
        //    var requisitions = _context.tbl_Rent_MC_Requisition.ToList();
        //    return View(requisitions);
        ...
        //{
        //    // Retrieve the data you need for the report
        //    var requisitionData = _context.tbl_Rent_MC_Requisition.FirstOrDefault(r => r.RID == id);

        //    // Create your report instance
        //    var report = new XtraReport(); // Replace with your actual report class
        //                                   // Set the data source or parameters for the report
        //                                   // report.DataSource = requisitionData; // Adjust as necessary
