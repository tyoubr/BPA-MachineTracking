...
namespace BPAMatchineTrack.ViewModels
{
    public class RentMCRequisitionViewModel
    {
        public tbl_Rent_MC_Requisition Requisition { get; set; } = new tbl_Rent_MC_Requisition();
        ...
        // Detail rows
        public List<tbl_Rent_MC_Req_D> RequisitionDetails { get; set; } = new List<tbl_Rent_MC_Req_D>();
    }
}
